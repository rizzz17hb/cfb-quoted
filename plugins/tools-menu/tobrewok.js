    ...
    exec: async ({ conn, m, command, usedPrefix }) => {
        ...
        if (!mime || !/image\/(jpe?g|png|webp)/.test(mime)) {
            ...
            return conn.sendMessage(m.chat, { 
                ...
                caption: `⚠️ Silahkan reply gambar yang mau dijadiin brewokan` 
            }, { quoted: m });
        }
        ...
        try {
            ...
            // Hit API FAA - ToBrewok
            const apiUrl = `https://api-faa.my.id/faa/tobrewok?url=${encodeURIComponent(catboxUrl)}`;
            ...
            await conn.sendMessage(m.chat, {
                image: resultBuffer,
                caption: "✨ Berhasil menambahkan efek brewok."
            });

            m.react('✅');

        } catch (e) {
            console.error('ToBrewok Error:', e);
            m.react('❌');
