    ...
    exec: async ({ conn, m, command, usedPrefix }) => {
        ...
        if (!mime || !/image\/(jpe?g|png|webp)/.test(mime)) {
            ...
            return conn.sendMessage(m.chat, { 
                ...
                caption: `⚠️ Silahkan reply gambar yang mau dijadiin botak` 
            }, { quoted: m });
        }
        ...
        try {
            ...
            // Hit API FAA - ToBotak
            const apiUrl = `https://api-faa.my.id/faa/tobotak?url=${encodeURIComponent(catboxUrl)}`;
            ...
            await conn.sendMessage(m.chat, {
                image: resultBuffer,
                caption: "✨ Berhasil mengubah ke gaya botak."
            });
